...
sender_password = "mhatitrqksidhwnk"
...
def image_page():
    ...
    if request.method == 'POST':
        ...
        if request.form.get("form_type") == "followup":
            ...
            prompt = str(
                f'AUTOGENERATED MESSAGE || {current_user.firstname}: Hello Doctor, the website predicted that I have the following disease {prediction[0]} with the probability of {float(prediction[1])}%')
